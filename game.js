...
const WEATHER_LIST = ['晴', '阴', '雨', '雨夜', '雾', '雪', '夜'];
...
时辰天气规则（timeWeather 字段）：
- 只有叙事跨越大段时间（赶路、守夜、一觉到天明等）才填 "advanceHour": true，普通对话、短暂查探不要推进时辰。
- 天气只在剧情合理时变化，新值必须是：晴、阴、雨、雨夜、雾、雪、夜 之一；不变就省略该字段。
